...
def main():
    ...
    variance=st.number_input("Variance","Type here")
    skewness = st.number_input("Skewness", "Type here")
    curtosis = st.number_input("Curtosis", "Type here")
    entropy = st.number_input("Entropy", "Type here")
    result=""
